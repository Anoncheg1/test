...
public class CaptchaGen {
        ...
        public BufferedImage generate(StringBuilder sb) {
                ...
                java.util.List<String> badfonts = Arrays.asList(new String[]{"MathJax_Script","MathJax_Size2", "MathJax_WinChrome","MathJax_AMS","MathJax_WinIE6", "Droid Sans Fallback","OpenSymbol", "Standard Symbols L"});
                ...
                do{
                	...
                	//if (badfonts.contains(fonts[fnum]))
                		//System.out.println("wtf");
                }while(badfonts.contains(fonts[fnum])|| fonts[fnum].startsWith("STIX"));
